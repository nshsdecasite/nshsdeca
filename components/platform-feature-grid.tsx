...
export async function DashboardQuickLinks() {
  ...
  const quickLinks = [
    ...
    { label: "Vocab flashcards", href: "/study/vocab", live: true },
    { label: "Visual library", href: "/study/visuals", live: true },
    { label: "Theories library", href: "/study/theories", live: true },
